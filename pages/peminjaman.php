...
<div class="container-fluid konten">
	<div>
		<h3 class="text-center">DATA PEMINJAMAN</h3><hr style="border: 1px solid #5c3701;">
		<a href="index.php?p=input-pinjam" class="btn btn-primary"><span class="fa fa-edit"></span> Tambah Data</a><hr>
    	...
    	<table id="data" class="table table-bordered table-hover">
            ...
            $no = 1;
            $data = mysqli_query($db,"SELECT tb_pinjaman.id_pinjam, tb_pinjaman.id_buku, tb_pinjaman.id_anggota, tb_pinjaman.tgl_pinjam, tb_pinjaman.tgl_tempoKembali, tb_pinjaman.status, tb_anggota.nama as nama_anggota, tb_buku.judul FROM tb_pinjaman JOIN tb_anggota ON tb_anggota.id_anggota=tb_pinjaman.id_anggota JOIN tb_buku ON tb_buku.id_buku=tb_pinjaman.id_buku WHERE tb_pinjaman.status='Sedang Meminjam' ORDER BY tb_pinjaman.tgl_pinjam desc");
